...
<html>
	...
	%>
				...
				<!-- Menu -->
					<nav id="menu">	
						...
						<ul class="actions vertical">
							<li><h5>회원가입</h5></li>
							<!-- 전송해야하는 데이터의 name값을 달아줄 때, DB table의 column명과 일치시키는 습관을 들이자! -->
		...
		<!-- Scripts -->
			...
			<!-- contact id == email에 대한 스크립트 -->
			<script type="text/javascript">
				// 1. id값이 email인 태그를 DOM형식으로 가져와서 키보드 입력에 대한 이벤트 등록
				$("#email").on("keyup",function(){
					// 2. id값이 email태그안에 들어있는 데이터 꺼내와서 객체 형태로 생성
					let email = {
								"email" : $(this).val()
						};
					// 3. 비동기통신을 사용해서 email 확인 기능 만들기
					$.ajax({
